 ...
 *  elsewhere in this library: a new carrier is only worth it when something must read the value *as* one.
 *
 ...
 *  component/coordinate count mismatch, a repeated coordinate.  That is the rule that
 ...
 *  node shape is final and the curvilinear systems — cylindrical and spherical, via the general orthogonal
